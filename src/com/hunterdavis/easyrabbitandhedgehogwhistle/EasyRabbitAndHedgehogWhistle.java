package com.hunterdavis.easyrabbitandhedgehogwhistle;
...
public class EasyRabbitAndHedgehogWhistle extends Activity { 
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		OnClickListener dogTwoListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 23750);
			}
		};
		...
		OnClickListener dogThreeListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 24250);
			}
		};
		...
		OnClickListener dogFourListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 25100);
			}
		};
